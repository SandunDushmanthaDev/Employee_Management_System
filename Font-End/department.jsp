...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="department.jsp" class="nav-item active">
            <i class="fa-solid fa-building"></i> Departments
        </a>
        <a href="position.jsp" class="nav-item">
            ...
            <div class="table-section">
                ...
                <div class="table-wrap">
                    <table>
                        <thead>
                        <tr>
                            <th style="width: 150px;">Dept. ID</th>
                            <th>Department Name</th>
                        </tr>
                        </thead>
                        <!-- ✅ Database eken load වෙනවා -->
                ...
                <div class="table-footer" style="justify-content: center; opacity: 0.7;">
                    <small>System managed All Departments</small>
                </div>
            </div>
        </div>
    </div>
